        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BannerUrl2 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BannerUrl3 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MarqueeText = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ContactZalo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ContactPhone = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ContactEmail = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ContactAddress = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MapHtml = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FooterAbout = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    DmcaUrl = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AccountItems_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccountItems_ProductId",
                table: "AccountItems",
                column: "ProductId");
